...
SECRET_KEY = 'django-insecure-7^%g0yf(mw@0d$yrhb@+73+lw*ub7!y_%z4s)7gswpt17ur8^@'
...
if PRODUCTION:
    ...
    DATABASES = {
        'default': {
            ...
            'NAME': os.getenv('mafaza.ananda'),
            'USER': os.getenv('mafaza.ananda'),
            'PASSWORD': os.getenv('FpBhWveI'),
